const acronym_table = {
    ...
    K: ['Kite', 'Kangaroo', 'Kid', 'Kiss', 'Knight', 'Killer', 'Kaleidescope', 'Kedgeree', 'Keyboard', 'Ketchup'],
    ...
    N: ['Nun', 'Noon', 'Nap', 'Night', 'Nickel', 'Nine', 'Next', 'Nexus', 'Ninety', 'Neptune', 'Normandy', 'Number'],
