...
const acronymTable = {
    ...
    D: ['Dinosaur', 'Disc', 'Dog', 'Daddy', 'Destiny', 'Daffodil', 'Dunkirk', 'Devil', 'Darkness', 'Dip'],
    ...
    L: ['Llama', 'Lord', 'Level', 'List', 'Lunchbox', 'Letter', 'Landscape', 'Left', 'Love', 'Lebenon', 'License'],
    M: ['Master', 'Monster', 'Magic', 'Minister', 'Music', 'Musical', 'Mustard', 'Mayor', 'Manor', 'March', 'Mummy', 'Mommy'],
    N: ['Nun', 'Noon', 'Nap', 'Nixon', 'Nickel', 'Nine', 'Next', 'Nexus', 'Ninety', 'Neptune', 'Normandy', 'Number', 'Newspaper'],
    O: ['Option', 'Orange', 'Original', 'Order', 'One', 'Octagon', 'Oval', 'Ostrich', 'Opal', 'Orangutan', 'Olive'],
    P: ['Pharaoh', 'Peru', 'Pokemon', 'People', 'Pineapple', 'Peach', 'Pipe', 'Pistol', 'Periscope', 'Pork', 'Picture', 'Pascal', 'Person', 'Pasta', 'Porche', 'Pie'],
    Q: ['Quilt', 'Quest', 'Quale', 'Queen', 'Query', 'Quack', 'Question', 'Quitter', 'Quidditch'],
    R: ['Reader', 'Raspberry', 'Rock', 'Rope', 'Revolver', 'Rome', 'Romeo', 'Rust', 'Rapier', 'Rapper'],
    S: ['Salmon', 'Silver', 'Sword', 'Silk', 'Seven', 'Shroud', 'Saxaphone', 'Service', 'Serpent', 'Snake', 'Sniper', 'Shape', 'Submarine'],
    T: ['Time', 'Task', 'Torch', 'Talent', 'Twelve', 'Trumpet', 'Taxonomy', 'Tungsten', 'Turkey', 'Tablet'],
    U: ['Underwear', 'User', 'Unicorn', 'Uvula', 'Umbrella', 'Up', 'Ulysses', 'Uganda', 'Underwriter', 'Undertaker', 'Ulcer'],
    V: ['Vegetable', 'Vegan', 'Virus', 'Vacation', 'Venus', 'Voice', 'Vampire', 'Vocation', 'Violin', 'Versailles', 'Vatican'],
    W: ['Watermelon', 'Water', 'West', 'Wombat', 'Wonder', 'Weekend', 'Westeros', 'Woman', 'Welcome', 'Warehouse', 'Warranty', 'Wallet'],
